              ...
              <div className="mx-4 mb-6 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <CurrencyInput
                    ...
                    className="flex-1 bg-gray-100 border-0 rounded-lg"
                    placeholder="Valor"
                  />
                </div>
          ...
          <div className="bg-white border border-t-0 border-gray-100 rounded-b-2xl px-4 py-5 space-y-4">
            <div>
              ...
              <Input
                ...
                className={`h-12 rounded-xl bg-white px-4 text-gray-900 placeholder:text-gray-500 focus-visible:ring-1 focus-visible:ring-[hsl(221,83%,53%)] focus-visible:border-[hsl(221,83%,53%)] ${errors.name ? 'border-destructive' : ''}`}
              />
            ...
            <div>
              ...
              <div className="relative">
                <PhoneInput
                  ...
                  className={`h-12 rounded-xl bg-white px-4 text-gray-900 placeholder:text-gray-500 focus-visible:ring-1 focus-visible:ring-[hsl(221,83%,53%)] focus-visible:border-[hsl(221,83%,53%)] ${errors.phone ? 'border-destructive' : ''}`}
                />
