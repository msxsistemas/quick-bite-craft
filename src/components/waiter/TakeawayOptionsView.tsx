...
interface TakeawayOptionsViewProps {
  customerName: string;
...
export const TakeawayOptionsView = ({
  customerName,
  customerPhone,
  subtotal,
  onBack,
    ...
    <div className="min-h-screen bg-[#0d2847] flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto pb-32">
            ...
            {hasProducts ? (
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-cyan-400 font-bold">{formatCurrency(subtotal)}</p>
                </div>
                <button 
        ...
        <div className="p-4">
          ...
          <div className="bg-[#0d2847] rounded-b-xl border border-[#1e4976] border-t-0">
            {!hasProducts ? (
              ...
              <>
                <p className="text-slate-400 text-sm p-4 pb-2">Pagamento no balcão</p>
        ...
        <div className="p-4">
          ...
          <textarea
            ...
            placeholder="Ex.: Embalagem extra, etc."
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#0d2847] border-t border-[#1e4976] p-4">
        ...
        <button
          ...
          disabled={!paymentMethod || paymentMethod === 'dinheiro' || !hasProducts}
