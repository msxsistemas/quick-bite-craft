...
export const FloatingCart: React.FC<FloatingCartProps> = ({ disabled = false, nextOpenTime }) => {
  ...
  return (
    <>
      ...
      {/* Floating Button - only show when cart has items and sheet is closed */}
      {!isOpen && totalItems > 0 && (
        <div className="fixed bottom-[52px] left-0 right-0 z-40 bg-background px-4 py-3 shadow-[0_-2px_10px_rgba(0,0,0,0.15)]">
          <div className="flex items-center justify-between">
            <div>
